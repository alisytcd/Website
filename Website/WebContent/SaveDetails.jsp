...
/* 	String para1= request.getParameter("username");
    ...
    String sqlStmt = "INSERT INTO USER(username,address,name,phone,email,picture,password) VALUES('"+user.getUsername()+"','"+user.getAddress()+"','"+user.getName()+"','"+user.getPhone()+"','"+user.getEmail()+"','"+user.getPicture()+"','"+user.getPassword()+"');";
